...
class Command(ABC):
    ...
    Commands store operation parameters (IDs, movement deltas...) and snapshot relevant model state (original/final positions, clipboard) during construction or finalization.
